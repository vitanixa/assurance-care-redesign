    ...
    <Layout>
      ...
      <section className="bg-[#1E3F20] text-white py-20 px-6 relative overflow-hidden shrink-0">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-4 relative z-10">
          <span className="text-[10px] font-extrabold text-[#E6A15C] uppercase tracking-widest">Our Credentials</span>
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-7 space-y-6">
          <span className="text-[10px] font-extrabold text-[#E6A15C] uppercase tracking-widest">Uncompromising Standards</span>
          ...
          <div className="bg-slate-50 border border-slate-100 p-5 rounded-xl space-y-3">
            <h4 className="text-sm font-extrabold text-[#1E3F20] flex items-center gap-2">
              <Award className="w-5 h-5 text-[#E6A15C]" /> Specialized Memory & Cognitive Support
            </h4>
        ...
        <div className="lg:col-span-5 relative flex justify-center">
          <div className="relative w-full max-w-[360px] aspect-[4/5] rounded-2xl overflow-hidden border border-slate-100 shadow-2xl">
            ...
            <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur p-4 rounded-xl border border-slate-100 shadow-lg space-y-1">
              <span className="text-[8px] font-bold text-[#1E3F20] uppercase tracking-widest">In-Depth Assessment</span>
              <p className="text-xs font-black text-[#1E3F20]">Evaluating physical & social needs prior to care</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-slate-50 py-20 px-6 border-y border-slate-100">
        <div className="max-w-7xl mx-auto space-y-12">
          <div className="text-center space-y-3 max-w-2xl mx-auto">
            <span className="text-[10px] font-extrabold text-[#E6A15C] uppercase tracking-widest">Trust Metrics</span>
            <h2 className="text-3xl md:text-4xl font-black font-serif text-[#1E3F20] tracking-tight">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {credentials.map((cred, idx) => (
              <div 
                key={idx} 
                className="bg-white border border-slate-100/80 rounded-xl p-4 flex items-start gap-3 shadow-sm hover:border-[#1E3F20]/10 transition-colors"
              >
                <div className="w-5 h-5 rounded bg-[#1E3F20]/5 text-[#1E3F20] flex items-center justify-center shrink-0 mt-0.5">
      ...
      <section className="py-20 px-6 max-w-4xl mx-auto text-center space-y-6">
        ...
        <h2 className="text-2xl md:text-3xl font-black font-serif text-[#1E3F20]">Ready to Select the Right Caregiver?</h2>
