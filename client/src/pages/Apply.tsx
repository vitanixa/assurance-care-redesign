...
export default function Apply() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] font-sans">
      ...
      {/* ── POSITION BANNER ── */}
      {position && (
        <div className="bg-[#082B4D] text-white px-6 py-4">
          <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
            <div>
              <p className="text-[10px] font-black text-[#0F8F88] uppercase tracking-widest">Applying For</p>
            ...
            <div className="flex items-center gap-2 text-[11px] text-slate-300 font-semibold">
              <ShieldCheck className="w-4 h-4 text-[#0F8F88]" />
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-6 py-8 grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <aside className="lg:col-span-1 space-y-5 order-2 lg:order-1">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5 space-y-4">
            <h3 className="text-sm font-black text-[#082B4D]">Application Tips</h3>
            <ul className="space-y-3">
              {[
                ...
                <li key={i} className="flex items-start gap-2 text-xs text-slate-600 leading-relaxed">
                  <span className="w-4 h-4 rounded-full bg-[#0F8F88]/15 text-[#0F8F88] font-black text-[10px] flex items-center justify-center shrink-0 mt-0.5">
                    {i + 1}
                  </span>
                  {tip}
                </li>
          ...
          <div className="bg-[#082B4D] rounded-2xl p-5 space-y-4 text-white">
            <h3 className="text-sm font-black">Questions?</h3>
            <p className="text-xs text-slate-300 leading-relaxed">
              Our hiring team is available Monday–Friday, 9am–5pm.
            </p>
            <div className="space-y-2.5">
              <a href="tel:+14302570296" className="flex items-center gap-2 text-xs font-bold text-[#0F8F88] hover:underline">
                <Phone className="w-3.5 h-3.5" /> 430-257-0296
              </a>
              <a href="tel:+16156492231" className="flex items-center gap-2 text-xs font-bold text-[#0F8F88] hover:underline">
                <Phone className="w-3.5 h-3.5" /> 615-649-2231
              </a>
              <a href="mailto:info@assurancecarellc.com" className="flex items-center gap-2 text-xs font-bold text-[#0F8F88] hover:underline">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5 space-y-3">
            <div className="flex items-center gap-2">
              <Clock className="w-4 h-4 text-[#0F8F88]" />
              <h3 className="text-sm font-black text-[#082B4D]">Response Time</h3>
            </div>
            <p className="text-xs text-slate-500 leading-relaxed">
              Our hiring coordinators review all applications within <strong className="text-[#082B4D]">24–48 business hours</strong> and reach out directly by phone or email.
            </p>
          </div>
        ...
        <div className="lg:col-span-3 order-1 lg:order-2">
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
              <div>
                <h2 className="text-base font-black text-[#082B4D]">Employment Application</h2>
